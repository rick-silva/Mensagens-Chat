...
const MensagemOS = () =>{
    ...
    return(
        <details className="my-3">
            <summary className="text-2xl cursor-pointer">Mensagem Ordem de Serviço</summary>

            <div className="grid grid-cols-3">
                {
                
                cards.map( card => ( 
                    <div className="flex justify-evenly align-center card flex-col h-96 bg-slate-700 m-auto text-white text-justify rounded-3xl">
